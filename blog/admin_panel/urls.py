...
from admin_panel.views import  Updatebadword,Showbadword,Deletebadword,Showcategory,Createbadword,Showposts,Deleteposts,Createposts,Updateposts,Createcategory,Deletecategory,Updatecategory
